...
import { GridComponent, ColumnsDirective, Print, ColumnDirective, Filter, Inject, VirtualScroll, Sort, Page, Toolbar, Search, Group, ExcelExport, PdfExport, Edit, DetailRow, ForeignKey, SearchSettings } from '@syncfusion/ej2-react-grids';
...
export default function DataTable({ columns, data, addCol, childGrid, gridConfig,columnTemplate, ...props }) {
    ...
    return (
        ...
        >
                    ...
                    columns.map(
                        ...
                        c => {
                            ...
                            return (<ColumnDirective key={c.Name} field={c.Name}
                                ...
                                headerText={c.DisplayName} width='150'></ColumnDirective>)
            ...
            <Inject services={[ForeignKey, DetailRow, Toolbar, Search, Sort, ExcelExport, PdfExport, Edit, Page, Group, Filter]} />
        </GridComponent>
    )
}